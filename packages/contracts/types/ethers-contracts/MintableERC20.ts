...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface MintableERC20Interface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "allowance" | "approve" | "balanceOf" | "decimals" | "getRoleAdmin" | "grantRole" | "hasRole" | "initialize" | "mint" | "name" | "presaleAddress" | "renounceRole" | "revokeRole" | "supportsInterface" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Initialized" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer"): EventFragment;
...
encodeFunctionData(functionFragment: 'initialize', values: [AddressLike, AddressLike, string, string, BigNumberish]): string;
encodeFunctionData(functionFragment: 'mint', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'name', values?: undefined): string;
encodeFunctionData(functionFragment: 'presaleAddress', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'presaleAddress', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initialize: TypedContractMethod<
      [defaultAdmin_: AddressLike, minter_: AddressLike, name_: string, symbol_: string, initialSupply_: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    presaleAddress: TypedContractMethod<
      [],
      [string],
      'view'
    >
...
getFunction(nameOrSignature: 'name'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'presaleAddress'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
